...
export const defaultProductPageDesignSettings = {
  theme: {
    primary_color: "#E85D3D",
    secondary_color: "#1F7A5C",
  ...
  benefits: ["High quality product", "Fast delivery", "Cash on delivery available", "Easy replacement support"],
  faq: [
    {
...
const templateDesigns = {
  ...
  modern: {
    ...
    layout: { style: "modern", hero_alignment: "center", image_position: "top" },
    hero: {
      ...defaultProductPageDesignSettings.hero,
  ...
  classic: {
    ...
    layout: { style: "classic", hero_alignment: "center", image_position: "top" },
    hero: {
      ...defaultProductPageDesignSettings.hero,
      badge_text: "Premium Pick",
    },
  },
  minimal: {
    ...defaultProductPageDesignSettings,
    ...
    layout: { style: "minimal", hero_alignment: "center", image_position: "top" },
    hero: {
      ...defaultProductPageDesignSettings.hero,
      badge_text: "Simple Deal",
    },
  },
  bold: {
    ...defaultProductPageDesignSettings,
    ...
    layout: { style: "bold", hero_alignment: "center", image_position: "top" },
    hero: {
      ...defaultProductPageDesignSettings.hero,
