    ...
    const workSteps = [
        {
            ...
            desc: t("ফেসবুক, ইনস্টাগ্রাম, ইউটিউব বা টিকটকে আমাদের পণ্যের ছবি/ভিডিও শেয়ার করুন আপনার নিজস্ব প্রাইস দিয়ে।")
        },
        {
            title: t("ধাপ ২ - অর্ডার সাবমিট:"),
            desc: t("কাস্টমার যখন অর্ডার করবে, আপনি শুধু আমাদের প্যানেলে অর্ডারটি আপনার প্রাইস সহ সাবমিট করবেন।")
        },
        {
        ...
        },
        {
            ...
            desc: t("ডেলিভারি সফল হলে আপনার ড্যাশবোর্ডে আপনার প্রফিট জমা হয়ে যাবে এবং যখন খুশি প্রফিট উইথড্র করে নিবেন।")
        }
    ];
    const resources = [
        {
