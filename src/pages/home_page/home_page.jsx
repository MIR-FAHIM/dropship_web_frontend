                ...
                <div className="max-w-8xl mx-auto">
                    ...
                    {data?.data.map((mainCategory) => (
                        <div key={mainCategory.id} className="mb-8">
                            <h2 className="text-xl font-semibold text-gray-700 bg-blue-100 p-2 rounded-md">{mainCategory.main_cat_name}</h2>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-4">
                                {mainCategory.product_categories.map((productCategory) => (
                                    <div
                                        ...
                                        onClick={() => handleProductCat(productCategory.id)}
                                    ...
                                    >
                                        <div className="aspect-square bg-gray-200 border-2 border-gray-300 rounded-lg">
                                            <img
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 bg-gray-800 text-white p-2 text-center">
                                                <h3 className="text-sm font-semibold">{productCategory.product_cat_name}</h3>
                                            </div>
                                        </div>
                                    </div>
                                ))}
