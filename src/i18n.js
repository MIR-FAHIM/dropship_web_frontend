  ...
  en: {
    translation: {
      ...
      product_details: {
        ...
        reseller_workspace: "Reseller workspace",
        sku: "SKU",
        ...
        unit: "Unit",
        shop: "Shop",
        set_selling_price: "Set your selling price",
        set_selling_price_sub: "Maximum suggested selling price for the product",
        your_price: "Your price",
        enter_price_placeholder: "Enter your price",
        profit_per_item: "Profit per item",
        margin_on_base: "Margin on base",
        quantity: "Quantity",
        total_sell_value: "Total sell value",
        total_base_cost: "Total base cost",
        total_profit: "Total profit",
        adding: "Adding...",
        add_to_cart: "Add to cart at your price",
        step1_title: "Copy & download",
        step1_desc: "Grab product title, description, and images for your store.",
        step2_title: "Set your price",
        step2_desc: "Adjust selling price based on your margin and market.",
        step3_title: "Order when sold",
        step3_desc: "Come back and place your order using your selling price.",
...
"faq": {
    ...
    'steps':{
      ...
      product_details: {
        loading: "লোড হচ্ছে...",
        download_assets: "অ্যাসেট ডাউনলোড",
        copy_title: "শিরোনাম কপি করুন",
        copy_description: "বিবরণ কপি করুন",
        reseller_workspace: "রিসেলার ওয়ার্কস্পেস",
        sku: "SKU",
        ...
        unit: "ইউনিট",
        shop: "শপ",
        set_selling_price: "আপনার বিক্রয় মূল্য নির্ধারণ করুন",
        set_selling_price_sub: "প্রোডাক্টির সাজেস্টেড বিক্রয় মূল্য সর্বোচ্চ",
        your_price: "আপনার মূল্য",
        enter_price_placeholder: "মূল্য লিখুন",
        profit_per_item: "প্রতিটিতে লাভ",
        margin_on_base: "বেসের উপর মার্জিন",
        quantity: "পরিমাণ",
        total_sell_value: "মোট বিক্রয় মূল্য",
        total_base_cost: "মোট বেস খরচ",
        total_profit: "মোট লাভ",
        adding: "যোগ হচ্ছে...",
        add_to_cart: "আপনার মূল্যে কার্টে যোগ করুন",
        step1_title: "কপি ও ডাউনলোড",
        step1_desc: "আপনার স্টোরের জন্য পণ্যের শিরোনাম, বিবরণ ও ছবি নিন।",
        step2_title: "আপনার মূল্য নির্ধারণ করুন",
        step2_desc: "আপনার মার্জিন ও বাজার অনুযায়ী বিক্রয় মূল্য ঠিক করুন।",
        step3_title: "বিক্রি হলে অর্ডার করুন",
        step3_desc: "ফিরে এসে আপনার বিক্রয় মূল্য দিয়ে অর্ডার করুন।",
        description: "বিবরণ",
        image_assets: "ছবি অ্যাসেট",
        details: "বিস্তারিত",
        download: "ডাউনলোড",
        add_to_favorites: "প্রিয়তে যোগ করুন",
        remove_from_favorites: "প্রিয় থেকে সরান",
        image_not_available: "ছবি পাওয়া যাচ্ছে না",
